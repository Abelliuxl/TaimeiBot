...
async def fetch_talent_loadouts(spec_simple):
    ...
    with open(os.path.join(base_dir, 'config', 'Abbreviations.json')) as f:
    ...
    with open(os.path.join(base_dir, '..', 'raider_data', 'player_info.json')) as f:
    ...
    # 读取en_cn_wow.json文件
    with open(os.path.join(base_dir, 'config', 'en_cn_wow.json'), 'r', encoding='utf-8') as f:
